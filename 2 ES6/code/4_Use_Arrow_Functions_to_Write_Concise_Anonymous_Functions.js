...
Instead, you can use arrow function syntax:
                                */
const myFunc2 = () => {         // chnage myFunc2 to myFunc
    const myVar = "value";
    return myVar;
}
...
arrow function syntax allows you to omit the keyword return as well as 
the brackets surrounding the code. 
This helps simplify smaller functions into one-line statements:
                                        */

const myFunc3 = () => "value"; // chnage myFunc3 to myFunc
