...
// The console.log will display the value [5, 6, 45].
                                    ...
                                    /*
As you can see, you can mutate the object [5, 6, 7] itself and 
the variable s will still point to the altered array [5, 6, 45]. 
...
const s1 = [5,7,2]; // chnage s1 to s
function editInPlace () {
    s1[0] = 2;
    s1[1] = 5;
    s1[2] = 7;
}
console.log(editInPlace(s1));