...
// The console would display the values 1, 2 and [3,4,5,6,7].
...
As in, you cannot use the rest parameter to catch a subarray that leaves out 
...
an effective Array.prototype.slice() so that arr is a sub-array of 
...
function removeFirstTwo(list){
    ...
    const [a2, b2, ...arr1] = list;
    // Only change code above this line
    return arr1;
}
const arr1 = removeFirstTwo(source);
console.log("Question Answer: ", arr1);