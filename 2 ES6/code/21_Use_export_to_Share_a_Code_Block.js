...
// The above is a common way to export a single function, but you can achive the same thing like this:
...
it without having to rewrite the code. You can export multiple things by repeating the 
first example for each thing you want to export, or by placing them all in the export statement of the second example, like this:
                                                */
...
export { add1, subtract};
                                                ...
                                                /*
                                            Question
There are two string-releated functions inn the editor. Export both of themusing the method of your choice.
                                                */
