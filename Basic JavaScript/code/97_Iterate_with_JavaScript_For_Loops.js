...
When the condition is false at the start of the iteration, 
...
const ourArray1 =[]; // change ourArray1 to ourArray

for (let i = 0; i <5; i++) {
    console.log(ourArray1.push(i));
}
...
const myArray1 = []; // change myArray1 to myArray

for (let i = 1; i <= 5; i++) {
    console.log(myArray1.push(i));
}
