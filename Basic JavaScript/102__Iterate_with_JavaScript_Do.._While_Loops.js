...
the value of ourArray is [5]. Essentially, a do...while loop ensures that the code inside the loop will run at least once. 
Let's try getting a do...while loop to work by pushing values to an array.
                                            */

                                            /*
                                        Question
Change the while loop in the code to a do...while loop so 
...
// Setup
const myArray = [];
let i4 =10; // change i4 to i
//  Only change code below this line
do {
    myArray.push(i4); // change i4 to i
    i4++; // change i4 to i
} while (i4<10);
